      ...
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 px-4">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          ...
          <div className="flex flex-col space-y-3">
            <Link href={"/admin/users" as Route} className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition text-center">
              View All Users
            </Link>
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          ...
          <div className="flex flex-col space-y-3">
            <Link href={"/admin/brokers" as Route} className="px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition text-center">
              View All Brokers
            </Link>
          </div>
        </div>
